...
CXXFLAGS := $(RESAMPLE_DEFINES) $(VECTOR_DEFINES) $(ALLOCATOR_DEFINES) -I. $(THIRD_PARTY_INCLUDES) -Wall -Wextra -Werror -fpic -std=c++98
CFLAGS	:= $(RESAMPLE_DEFINES) $(VECTOR_DEFINES) $(ALLOCATOR_DEFINES) -I. $(THIRD_PARTY_INCLUDES) -Wall -Wextra -Werror -fpic
